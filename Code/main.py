...
def fit_GAN(run, g_model, d_model, c_model, gan_model, n_samples, n_classes, X_sup, y_sup, dataset, n_epochs, n_batch, latent_dim = 100):
    ...
    with open('/home/limikgyun/CGAN_Zero_Tensor/Storage/시각화/CSV_d_model_predictions.csv', mode='w', newline='') as file:
        ...
        for i in range(n_steps):
            ...
            if (i+1) % (bat_per_epo * 1) == 0:
                ...
                #     plt.grid(True)
                #     plt.plot(x_g)
                # plt.savefig('/home/limikgyun/CGAN_Zero_Tensor/Storage/시각화/Base-GAN-에폭%d.png' % ((i+1)//bat_per_epo), dpi=400)
                # plt.close()
    return tst_history
...
def fit_CGAN(run, g_model, d_model, gan_model, n_samples, n_classes, X_sup, y_sup, dataset, n_epochs, n_batch, latent_dim=100):
    ...
    folder_path = '/home/limikgyun/CGAN_Zero_Tensor/Storage/시각화/{}'.format(current_time)
...
def run_base(pickle_file_path):  # pickle_file을 매개변수로 받도록 수정
    ...
    for j in range(len(n_samples)):
        ...
        # save models:
        g_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-{}-g-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))
        d_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-{}-d-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))
        c_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-{}-c-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))
...
def run_trans_cgan(pickle_file_path, d_path, g_path):# 전이학습의 base가 될 cGAN 모델 학습
    ...
    for j in range(len(n_samples)):
        ...
        # Save models
        g_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-C간-{}-g-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))
        d_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-C간-{}-d-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))
...
def run_trans_base(n_epochs, pickle_file_path, c_path, d_path, g_path):# base 모델(G/C/D GAN)을 불러와서 Transfer Learning / 데이터에 몇몇 레이블을 빼고, removed_select_supervised_samples 함수를 사용 해서 전이학습 실시
    ...
    #load dataset
    dataset = data_preproc(np.asarray(pickle.load(open(pickle_file_path,'rb'))))
    # dataset = data_preproc(np.asarray(pickle.load(open('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged b (Real[0,2]+Fake[1])_csi.pickle','rb'))))
    # dataset = data_preproc(np.asarray(pickle.load(open('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Generated_b.pickle','rb'))))
    
    # # 특정 레이블로만 학습하는 데이터셋
    # selected_label = 1 # 0부터 5까지의 레이블 중 선택해서 removed_select_supervised_samples 기능에서 사용하게됨
    # dataset = data_preproc(np.asarray(pickle.load(open(f'/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Only_label_{selected_label}.pickle','rb'))))
    ...
    for j in range(len(n_samples)):
        ...
        # save models:
        # g_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-Base간-{}-g-{}샘플-{}에폭-{}.h5'.format(data_name, n_samples[j], n_epochs, int(best*100)))
        # d_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-Base간-{}-d-{}샘플-{}에폭-{}.h5'.format(data_name, n_samples[j], n_epochs, int(best*100)))
        c_model.save('/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-Base간-{}-c-{}샘플-{}에폭.h5'.format(data_name, n_samples[j], n_epochs))

if __name__ == '__main__':    
    # 241004 새 실험을 위한 절차
    # # for x
    pickle_files = [
    '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_aa_000.pickle',
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_x++_00.pickle'
    ]
    for pickle_file in pickle_files:
    #     run_base(pickle_file)
        run_cgan(pickle_file)

    # run_trans_cgan(9, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_x++_00.pickle',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_x_00-d-3000샘플-100에폭.h5'
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_x_00-g-3000샘플-100에폭.h5')        
    # run_trans_base(90, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Generated_[1]_x++_00.pickle',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x_00-c-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x_00-d-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x_00-g-3000샘플-100에폭.h5')
    # run_trans_cgan(9, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_x_00.pickle',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_x++_00-d-3000샘플-100에폭.h5',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_x++_00-g-3000샘플-100에폭.h5')        
    # run_trans_base(90, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Generated_[1]_x_00.pickle',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x++_00-c-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x++_00-d-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_x++_00-g-3000샘플-100에폭.h5')
    # for z
    # pickle_files = [
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_z_00.pickle',
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_z++_00.pickle'
    # ]
    # for pickle_file in pickle_files:
    #     run_base(pickle_file)
    # for pickle_file in pickle_files:
    #     run_cgan(pickle_file)
    # run_trans_cgan(9,
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_z++_00.pickle',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_z_00-d-3000샘플-100에폭.h5'
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_z_00-g-3000샘플-100에폭.h5')        
    # generate_csi_by_CGAN('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_z++_00.pickle',
    #                      '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-C간-Removed_[1]_z++_00-g-1000샘플-9에폭.h5')
    # run_trans_base(90, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Generated_[1]_z++_00.pickle',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z_00-c-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z_00-d-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z_00-g-3000샘플-100에폭.h5')
    # run_trans_cgan(5, 
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_z_00.pickle',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_z++_00-d-3000샘플-100에폭.h5',
    #                '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-Processed_z++_00-g-3000샘플-100에폭.h5')
    # generate_csi_by_CGAN('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_z_00.pickle',
    #                      '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-C간-Removed_[1]_z_00-g-1000샘플-5에폭.h5')      
    # generate_csi_by_CGAN('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_[1]_z_00.pickle',
    #                      '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Trans-C간-Removed_[1]_z_00-g-1000샘플-9에폭.h5')        
    # run_trans_base(7, '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Generated_[1]_z_00.pickle',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z++_00-c-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z++_00-d-3000샘플-100에폭.h5',
    #                     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-Processed_z++_00-g-3000샘플-100에폭.h5')
    ...
    # #1 제안사항 학습 순서
    # pickle_files = [
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_x_00.pickle',
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_x+_00.pickle',
    # '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_x++_00.pickle'
    # ]
    # for pickle_file in pickle_files:
    ...
    #     '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Removed_c_0[0,2].pickle',
    #     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-b-240923-2228-d-3000샘플-200에폭-100.h5',
    #     '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/C간-b-240923-2228-g-3000샘플-200에폭-100.h5')

#     run_trans_base(90,
# '/home/mnetlig/Desktop/CSI-SemiGAN-master//Merged b2c 7 (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-g-3000샘플-200에폭-100.h5')
    
#     run_trans_base(90,
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged b2c 9 (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-g-3000샘플-200에폭-100.h5')

#     run_trans_base(53,#83,0.9279999732971191 / #65 / #81 /#80
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged a2c 8 (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-g-3000샘플-200에폭-100.h5')


    # run_trans_base(80)    # 80 에포크가 적당 (분류정확도가 피크를 찍은 직후)
#     run_trans_base(80,
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged b2a (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-g-3000샘플-200에폭-100.h5')

#     run_trans_base(80,
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged a2c (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-a-240924-0008-g-3000샘플-200에폭-100.h5')
    
#     run_trans_base(80,
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Merged b2c (Real[0,2]+Fake[1])_csi.pickle',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-c-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-d-3000샘플-200에폭-100.h5',
# '/home/limikgyun/CGAN_Zero_Tensor/Storage/모델/Base간-b-240924-0021-g-3000샘플-200에폭-100.h5')
    ...
    # #2 제안사항 학습 순서
    # run_base('/home/limikgyun/CGAN_Zero_Tensor/Storage/데이터/Processed_b_0.pickle')
    # for i in range(1):
    #     # for label in [1, 3, 5]:
